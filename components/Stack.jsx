...
function Stack() {
  return (
    <div className={styles.stack}>
      ...
      <div className='drop-shadow-md hover:scale-110 transition ease-in duration-100'>
        <Image 
          src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/bootstrap/bootstrap-original.svg" width={60} 
          height={60} 
          alt='icono bootstrap' 
          title='Bootstrap' 
        />          
      ...
      <div className='drop-shadow-md hover:scale-110 transition ease-in duration-100'>
        <Image 
          src="https://cdn.jsdelivr.net/gh/devicons/devicon/icons/wordpress/wordpress-plain.svg" width={60} 
          height={60} 
          alt='icono wordpress' 
          title='Wordpress' 
        />
